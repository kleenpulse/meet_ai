...
export default function DashboardUserButton({
	...
	return (
		<DropdownMenu>
			<DropdownMenuTrigger className="rounded-lg border border-border/10 p-3 w-full flex items-center justify-between bg-white/5 hover:bg-white/10 overflow-hidden gap-0.5">
				{data.user.image ? (
					<Avatar>
						<AvatarImage
							src={data.user.image}
